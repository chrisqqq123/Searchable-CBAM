...
class ResNetCBAM_search_structure_2(nn.Module):
    def __init__(self, block, num_blocks, num_classes=100):
        super(ResNetCBAM_search_structure_2, self).__init__()
        self.in_planes = 64
...
def ResNetCBAMSS18_2():
    return ResNetCBAM_search_structure_2(BasicBlock, [2,2,2,2])

def ResNetCBAMSS34_2():
    return ResNetCBAM_search_structure_2(BasicBlock, [3,4,6,3])

def ResNetCBAMSS50_2():
    return ResNetCBAM_search_structure_2(Bottleneck, [3,4,6,3])

def ResNetCBAMSS101_2():
    return ResNetCBAM_search_structure_2(Bottleneck, [3,4,23,3])

def ResNetCBAMSS152_2():
    return ResNetCBAM_search_structure_2(Bottleneck, [3,8,36,3])